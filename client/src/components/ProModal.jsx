...
// GITROAST — Pro Modal
// ============================================================
// WHAT: Fullscreen upgrade prompt using React Portal.
// WHY Portal: bypasses parent CSS transforms/stacking contexts
//             so position:fixed always = viewport-fixed
// ============================================================
...
export default function ProModal({ onClose }) {
    ...
    const modalContent = (
        <div className="modal-overlay" onClick={onClose}>
            ...
            <style jsx>{`
        /* WHY 100dvh: dvh (dynamic viewport height) excludes mobile browser chrome
           100vh on iOS Safari includes address bar → modal overflows bottom
           dvh = always the actual visible area */
        .modal-overlay {
          position:        fixed;
          inset:           0;
          ...
          z-index:         9999;
          /* WHY dvh fallback: dvh not supported in older Safari */
          min-height:      100vh;
          min-height:      100dvh;
          overflow-y:      auto;
          /* WHY -webkit-overflow-scrolling: touch:
             enables momentum scrolling on iOS
             without it scrolling inside modal feels laggy on iPhone */
        ...
        .modal-box {
          ...
          /* WHY margin auto: centers in overlay when overlay is scrollable */
          margin:         auto;
        }
        .modal-close {
          position:   absolute;
          ...
          line-height:1;
          /* WHY z-index: sits above badge which is also absolute */
          z-index:    1;
        }
        ...
        /* Plans grid — 2 col on desktop, 1 col on mobile */
        .modal-plans {
          display: grid;
        ...
        .modal-plan {
          padding:        1.25rem;
          padding-top:    1.75rem; /* WHY: badge overflows top edge */
        ...
        /* Badge — absolutely positioned above card top edge */
        .modal-badge {
          position:      absolute;
          top:           -10px;
          left:          50%;
        ...
        .bullet-icon       { flex-shrink: 0; width: 16px; color: var(--good); }
        ...
        /* Tablet — plans start getting cramped below 560px */
